...
public interface DocumentCiteMapper extends BaseMapper<DocumentCite> {
    Page<CiteRelationPaperDto> getRefListById(Page<CiteRelationPaperDto> page, @Param("documentId") Integer documentId);

    Page<CiteRelationPaperDto> getCitingListById(Page<CiteRelationPaperDto> page, @Param("documentId") Integer documentId);
}